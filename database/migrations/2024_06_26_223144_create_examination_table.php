...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('examination', function (Blueprint $table) {
            ...
            $table->bigInteger('patient_id', false)->index()->comment('ID dari orang nya');
            $table->dateTime('examination_date')->comment('tanggal perawatannya');
            $table->bigInteger('doctor_id', false)->index()->comment('id dokter nya');
            ...
            $table->bigInteger('created_by', false)->index()->comment('id dari user yang menginput, walaupun sama antara dokter dan user');
